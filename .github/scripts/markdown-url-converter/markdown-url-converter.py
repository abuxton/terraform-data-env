...
def convert_markdown_urls(content: str, base_url: str, file_path: Path, root_dir: Path) -> str:
    ...
    patterns = [
        # [text](https://github.com/abuxton/terraform-data-env/blob/0.0.7/.github/scripts/markdown-url-converter/url) format
        (r'\[([^\]]+)\]\((?!http|#|mailto:)([^)]+)\)',
         lambda m: f'[{m.group(1)}](https://github.com/abuxton/terraform-data-env/blob/0.0.7/.github/scripts/markdown-url-converter/{urljoin(current_base_url + "/", m.group(2))})'
        ),
        # ![alt](https://github.com/abuxton/terraform-data-env/blob/0.0.7/.github/scripts/markdown-url-converter/image-url) format
        (r'!\[([^\]]*)\]\((?!http|#)([^)]+)\)',
         lambda m: f'![{m.group(1)}](https://github.com/abuxton/terraform-data-env/blob/0.0.7/.github/scripts/markdown-url-converter/{urljoin(current_base_url + "/", m.group(2))})'
        ),
